...
public class VatsimServer implements Serializable {
    ...
    public VatsimServer(String indent, String hostname, String location, String name, boolean connectAllowed, GeneralServerData generalData) {
        super();
        this.indent = indent;
